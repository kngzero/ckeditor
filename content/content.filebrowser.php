<?php
	...
	Class contentExtensionCkeditorFilebrowser extends HTMLPage
	{
		...
		public function build($context)
		{
			...
			$this->addStylesheetToHead(URL . '/symphony/assets/css/src/symphony.css', 'screen', 68);
			$this->addStylesheetToHead(URL . '/symphony/assets/css/src/admin.css', 'screen', 69);
			$this->addStylesheetToHead(URL . '/extensions/ckeditor/assets/filebrowser.css', 'screen', 70);
			$this->addScriptToHead(URL . '/symphony/assets/js/lib/jquery.js', 50);
